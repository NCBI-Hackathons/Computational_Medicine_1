...
*Input: penetrance estimate and snp chip data → processing of GWAS odds ratios → 3000 random snp collections from people without the phenotypic trait of the disease → Output: the polygenic score and how it compares to the 3000 random snp collections* 
